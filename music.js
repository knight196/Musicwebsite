...
audiolist.src=songlist[count].musicFile;
  ...
  audioplayer.addEventListener('click', () => { 
    ...
    document.querySelector('.border').style.animation="linear";
    audiolist.pause();
  }else if (audioplayer.innerHTML === '<i class="fas fa-play"></i>'){
    audioplayer.innerHTML = '<i class="fas fa-pause"></i>';
    play.innerHTML = '<i class="fas fa-pause"></i>';
    document.querySelector('.border').style.animation="borderbox 3.5s linear infinite";
    audiolist.play();
  }
  });
