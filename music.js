...
function loadSong(songlist) {
    ...
    bottomoptiontitle.textContent = songlist.musicName;
}
...
for (let i = 0; i < musicList.length; i++) {
    ...
    musicList[i].addEventListener('click', function(){
      ...
      document.querySelector('.bottomoptionlist').style.display="none";
      ...
      document.querySelector('.playlistbox').style.display="none";
...
document.querySelector('.bottomoptionlist').style.display="flex";
document.querySelector('section').style.display="grid";
document.querySelector('.bottomtrack').style.display="none";
});
...
//user will take to playlist page when it is clicked from three dots option

var playlistadded = document.getElementById('playlistadded');

playlistadded.addEventListener('click', () => {
document.querySelector('.playlistbox').style.display="block";
document.querySelector('.borderbox').style.display="none";
document.querySelector('.listoption').classList.remove('show');
document.querySelector('.playbuttonlist').style.display="none";
document.querySelector('.bottomtrack').style.display="flex";
document.querySelector('.thumbsup').style.color="white";
audiolist.pause();
audiolist.currentTime = 0;
});
...
//when user clicks on the bottom of the song it will take them to the music player

var bottomoptiontitle = document.querySelector('#bottomoptiontitle');

bottomoptiontitle.addEventListener('click', () => {
document.querySelector('.bottomoptionlist').style.display="none";
document.querySelector('.allmusiccollection').style.display="none";
document.querySelector('.musicscreen').style.display="block";
document.querySelector('section').style.display="none";
...
function ready(){
 ...
 document.querySelector('.thumbsup').addEventListener('click', addToPlaylistClicked);
...
player.pause();
player.currentTime =0;
tracklist.innerHTML = 'SongList';
}


function addToPlaylistClicked(){

var title = document.getElementsByClassName('title').innerText = document.querySelector('.songname').innerText;
var imgSrc =document.getElementsByClassName('playimg').src = document.querySelector('.img').src;
var audio =  document.querySelector('#audiolist').src;
addSong(title,imgSrc,audio);
document.querySelector('.thumbsup').style.color="blue";
}


function addSong(title, imgSrc,audio){
...
<div class="optionbtn">
<button onclick="playaudio('${audio}','${title}')">Play</button>
<button onclick="playstop('${audio}')">Stop</button>
...
function playaudio(music,title){
 player.src=music;
 tracklist.innerText=title;
player.play();
audiolist.pause();
}

function playstop(music){
  player.src=music;
  player.pause();
}
